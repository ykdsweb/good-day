      ...
      <table>
        <tbody>
          <tr className={styles.menuTablLast}>
            ...
            ※こちらの募集要項については倉敷中島店の内容です。<br />
            <br />
            その他店舗の募集要項については、条件、内容が異なる場合がございます。<br />
            <br />
        ...
        <tbody>
          <tr className={styles.menuTableTr}>
            ...
            <td className={styles.menuTableTd}>
              ワゴン(1台)、スタイリスト専用ロッカー(1台)<br />
              <br />
              ※施術に使用する道具・商材については各自ご準備ください。<br />
              <br />
              ※ご自身で使いやすい薬剤をご持参ください。(持込量は無し)<br />
              <br />
            </td>
          </tr>
        </tbody>
        ...
        <tr className={styles.menuTabl}>
            ...
            <td className={styles.menuTableTd}>
              サロン見学について<br />
              <br />
              サロン見学をご希望のスタイリストさんはGOOD-DAY公式LINEよりご連絡ください。<br />
              <br />
              ご希望のサロン見学の日程を第一希望から第三希望までご検討ください。<br />
              <br />
              【例】<br />
              ①4月12日(月) 10:00〜<br />
              ②4月13日(火) 11:00〜<br />
              ③4月14日(水) 12:00〜<br />
              <br />
              ※上記例を参考に、日付、曜日、お時間をお知らせいただけるとスムーズです。<br />
              <br />
              ※ご応募については、<span className={styles.fontColorRed}>必ず求職者ご本人様がご連絡ください。</span>代理の方や、業者の方の場合、正確なご案内ができない場合がございます。スムーズなご案内にご協力お願いします。
            </td>
          </tr>
        </tbody>
      </table>
